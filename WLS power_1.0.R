##########################################################################
## Fixed- & Mixed-model meta-WLS procedures based on Hedges & Pigott (2004) 
...
WLSpower = function(x, b, hetero.fit, tau2, beta.pred){
...
### Raw data must be in .csv format, and organized in column in the following order: 
### column 1, entitled as n or v: sample size (n) or variance (v),  
...
# use hetero.fit to specify the amount of heterogeneity (tau2) across effect sizes in fixed effect
### To specify hetero.fit, choose one out the options (including the quotes in your code): 
